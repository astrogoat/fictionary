<x-lego::section>
    <div class="fic-relative fic-isolate fic-px-6 fic-lg:px-8">
        ...
        <div class="fic-mx-auto fic-max-w-4xl fic-text-center">
            {!! $this->get('eyebrow.copy')->class('fic-text-base/7 fic-font-semibold fic-text-accent-600') !!}
        ...
        <div class="fic-mx-auto fic-mt-16 fic-grid fic-max-w-lg fic-grid-cols-1 fic-items-center fic-gap-y-6 sm:fic-mt-20 sm:fic-gap-y-0 lg:fic-max-w-4xl lg:fic-grid-cols-2">
            <div class="fic-rounded-3xl fic-rounded-t-3xl fic-bg-white/60 fic-p-8 fic-ring-1 fic-ring-gray-900/10 sm:fic-mx-8 sm:fic-rounded-b-none sm:fic-p-10 lg:fic-mx-0 lg:fic-rounded-bl-3xl lg:fic-rounded-tr-none">
                {!! $this->get('tiers.standard.name')->class('fic-text-base/7 fic-font-semibold fic-text-accent-600') !!}
                ...
                {!! $this->get('tiers.standard.cta')->class('fic-mt-8 fic-block fic-rounded-md fic-px-3.5 fic-py-2.5 fic-text-center fic-text-sm fic-font-semibold fic-text-accent-600 fic-ring-1 fic-ring-inset fic-ring-accent-200 hover:fic-ring-accent-300 focus-visible:fic-outline focus-visible:fic-outline-2 focus-visible:fic-outline-offset-2 focus-visible:fic-outline-accent-600 sm:fic-mt-10') !!}
            </div>
            <div class="fic-relative fic-rounded-3xl fic-bg-gray-900 fic-p-8 fic-shadow-2xl fic-ring-1 fic-ring-gray-900/10 sm:fic-p-10">
                {!! $this->get('tiers.emphasized.name')->class('fic-text-base/7 fic-font-semibold fic-text-accent-400') !!}
                <p class="fic-mt-4 fic-flex fic-items-baseline fic-gap-x-2">
                ...
                <ul role="list" class="fic-mt-8 fic-space-y-3 fic-text-sm/6 fic-text-gray-300 sm:fic-mt-10">
                    @foreach($this->get('tiers.emphasized.features') as $feature)
                        <li class="fic-flex fic-gap-x-3">
                            <x-fab::elements.icon :icon="$feature->icon->key" class="fic-h-6 fic-w-5 fic-flex-none fic-text-accent-400" />
                            {!! $feature->name !!}
                        </li>
                    @endforeach
                </ul>
                {!! $this->get('tiers.emphasized.cta')->class('fic-mt-8 block fic-rounded-md fic-bg-accent-500 fic-px-3.5 fic-py-2.5 fic-text-center fic-text-sm fic-font-semibold fic-text-white fic-shadow-sm hover:fic-bg-accent-400 focus-visible:fic-outline focus-visible:fic-outline-2 focus-visible:fic-outline-offset-2 focus-visible:fic-outline-accent-500 sm:fic-mt-10') !!}
            </div>
        </div>
    </div>
</x-lego::section>
