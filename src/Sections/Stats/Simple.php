...
class Simple extends Section implements SupportsContentVariations
{
    ...
    public function getGridDensityCss(): string
    {
        return match ($this->get('density')->getKey()) {
            'tight' => 'fic-max-w-lg fic-grid-cols-2 fic-gap-x-8 fic-gap-y-10 sm:fic-max-w-xl sm:fic-grid-cols-7 sm:fic-gap-x-10 lg:fic-mx-0 lg:fic-max-w-none lg:fic-grid-cols-6',
            ...
            'extra-spacious' => 'fic-max-w-lg fic-grid-cols-2 fic-gap-x-8 fic-gap-y-6 sm:fic-max-w-xl sm:fic-grid-cols-3 sm:fic-gap-x-10 lg:fic-mx-0 lg:fic-max-w-none lg:fic-grid-cols-3',
        };
    }
}
