...
class SimpleWithHeading extends Section
{
    ...
    public function getIconDensityCss(): string
    {
        return match ($this->get('density')->getKey()) {
            ...
            'extra-spacious' => 'fic-max-w-lg fic-grid-cols-1 fic-gap-x-8 fic-gap-y-10 sm:fic-max-w-xl sm:fic-grid-cols-3 sm:fic-gap-x-10 lg:fic-mx-0 lg:fic-max-w-none lg:fic-grid-cols-3',
        };
    }
